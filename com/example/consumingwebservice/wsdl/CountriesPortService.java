 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://www.baeldung.com/springsoap/gen", wsdlLocation = "http://localhost:8085/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://www.baeldung.com/springsoap/gen", "CountriesPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/ws/countries.wsdl");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://www.baeldung.com/springsoap/gen", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.baeldung.com/springsoap/gen", "CountriesPortSoap11"), CountriesPort.class, features);
    }
