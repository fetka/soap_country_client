...
public class CountriesPortService
  ...
  private final static QName COUNTRIESPORTSERVICE_QNAME = new QName(
      "http://www.baeldung.com/springsoap/gen", "CountriesPortService");
  ...
  /**
   * @return returns CountriesPort
   */
  @WebEndpoint(name = "CountriesPortSoap11")
  public CountriesPort getCountriesPortSoap11() {
    return super.getPort(new QName("http://www.baeldung.com/springsoap/gen", "CountriesPortSoap11"),
        CountriesPort.class);
  }
